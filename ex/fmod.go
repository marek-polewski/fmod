...
// #cgo linux,386  LDFLAGS: -L/../lib/linux/ -lfmodex
// #cgo linux,amd64  LDFLAGS: -L/../lib/linux64/ -lfmodex64
// #cgo CFLAGS: -Iinc
// #include "fmod.h"
...
func (s *System) CreateSound_FromFilename(filename string, mode Mode) (*Sound, error) {
	...
	var ferr C.FMOD_RESULT
	base.Thread(func() {
		ferr = C.FMOD_System_CreateSound(s.system, cstr_filename, C.FMOD_MODE(mode), (*C.FMOD_CREATESOUNDEXINFO)(nil), &sound.sound)
	})
	err := base.ResultToError(ferr)
	if err != nil {
		return nil, err

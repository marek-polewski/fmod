...
const (
	...
	INIT_PS3_DISABLEDTS                      = C.FMOD_INIT_PS3_DISABLEDTS
	INIT_PS3_DISABLEDOLBYDIGITAL             = C.FMOD_INIT_PS3_DISABLEDOLBYDIGITAL
	INIT_7POINT1_DOLBYMAPPING                = C.FMOD_INIT_7POINT1_DOLBYMAPPING
	INIT_ASYNCREAD_FAST                      = C.FMOD_INIT_ASYNCREAD_FAST
)
